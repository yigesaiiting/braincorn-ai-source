...
```bash
mkdir -p ~/Braincorn_Vault/{00_Inbox,Raw/{Markets,XingYu,Career,Writing,AI_Tools,Screenshots},Wiki/{Concepts,Companies,People,Playbooks,Products},Projects/{Trading_System,XingYu_Product,XingYu_Growth,Personal_Brand},40_Decisions/{Investment_Decisions,Product_Decisions,Career_Decisions},Outputs/{Daily_Market_Reports,Weekly_Reviews,PRDs,Deck_Outlines,Essays},90_System/{Templates,Prompts}}
...
你每天看到资料时，不要马上整理，先丢进 `Raw/`。

例如：

```text
Raw/Markets/2026-05-08_IREN_premarket.md
Raw/Markets/2026-05-08_CRWV_news.md
Raw/XingYu/2026-05-07_fandom_growth_notes.md
Raw/AI_Tools/2026-05-08_karpathy_llm_kb.md
```
...
|类型|放哪里|
|---|---|
|财报截图|`Raw/Markets/Screenshots/`|
|股票新闻|`Raw/Markets/`|
|交易社区热度结果|`Raw/Markets/`|
|饭圈活动方案|`Raw/XingYu/`|
|商场合作资料|`Raw/XingYu/`|
|文章灵感|`Raw/Writing/`|
|AI 工具教程|`Raw/AI_Tools/`|
...
5. 有没有股票页面缺少风险项。
6. 有没有星与产品页面缺少用户场景。
7. 输出一份 Outputs/Weekly_Reviews/wiki_lint_YYYY-MM-DD.md。
8. 不要自动删除文件，只提出修改建议。
```
...
```text
基于 Wiki/Companies 和 Outputs/Daily_Market_Reports，
...
3. 输出：
   ...
   - 适合的交易方式
   - 不适合进场的条件
4. 把结果写入 Outputs/Daily_Market_Reports/。
```

例如你问星与产品：

```text
基于 Wiki/Products、Projects/XingYu_Product 和 Raw/XingYu，
帮我整理“星与社区下一阶段产品闭环”。
...
```text
Wiki/Companies/Index.md
Wiki/Concepts/Index.md
Wiki/Playbooks/Index.md
Projects/XingYu_Product/Index.md
Projects/Trading_System/Index.md
```
...
```text
Wiki/Playbooks/盘前热度选股模型.md
Wiki/Playbooks/妖股识别模型.md
Wiki/Playbooks/财报催化交易模型.md
Wiki/Playbooks/期权小资金放大模型.md
Wiki/Concepts/FOMO.md
Wiki/Concepts/盘前放量.md
Wiki/Concepts/低流动性风险.md
```

每日 Codex prompt：

```text
请基于今天新增的 Raw/Markets 资料，更新我的“盘前热度选股模型”。
...
```text
Wiki/Products/星与社区.md
Wiki/Products/明星百科主页.md
Wiki/Products/明星代言品牌榜单.md
Wiki/Products/应援活动社区.md
Wiki/Playbooks/饭圈社区冷启动模型.md
Wiki/Playbooks/商场合作模型.md
Wiki/Playbooks/后援会入驻模型.md
```
...
```text
Wiki/Concepts/克制表达.md
Wiki/Concepts/男性冷感叙事.md
Wiki/Concepts/理论气质写作.md
Wiki/Concepts/品牌世界观.md
Wiki/Playbooks/小红书活动文案模型.md
Wiki/Playbooks/文学化品牌文案模型.md
```

Codex prompt：

```text
请整理 Raw/Writing 中的文本素材。

任务：
1. 提炼我的写作偏好。
2. 总结高频隐喻系统。
3. 建立“冷感克制表达”写作规范。
4. 把可复用句式放入 Wiki/Playbooks/。
5. 把具体文章草稿放入 Outputs/Essays/。
```
