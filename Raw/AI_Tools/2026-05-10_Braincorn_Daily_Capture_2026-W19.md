...
> 写入原则：原始资料保留在 `Raw/`；抽象方法沉淀到 `Wiki/`；正在推进的项目进入 `Projects/`；明确的新判断进入 `40_Decisions/`；可交付成品进入 `Outputs/`；系统规则与 AI 工作流进入 `90_System/`。
...
- `Wiki/Playbooks/AI高弹性成长股选股模型V2.md`
- `Wiki/Concepts/新身份重估.md`
...
- `Wiki/Concepts/题材潮流生命周期.md`
- `Wiki/Playbooks/热度股判断框架.md`
- `Wiki/Concepts/证券交易_vs_fashion_trends.md`
...
- `Wiki/Playbooks/盘前30分钟热度股SOP.md`
...
- `Projects/TradingScanner/盘前热度股扫描器需求.md`
...
- `Wiki/Playbooks/饭圈活动任务闭环.md`
- `Projects/XingYu/应援任务解锁系统PRD.md`
...
- `Wiki/Products/应援任务解锁系统.md`
- `Projects/XingYu/MVP/应援任务页.md`
- `Projects/XingYu/MVP/活动页_报名任务解锁结构.md`
...
- `Wiki/Products/应援资源解锁池.md`
- `Outputs/XingYu/后援会资源等级表.md`
- `Outputs/XingYu/商场资源包招商页.md`
...
- `Projects/XingYu/MVP/星与应援任务平台MVP.md`
- `Projects/XingYu/PRD/活动报名页PRD.md`
- `Projects/XingYu/PRD/应援任务页PRD.md`
- `Projects/XingYu/PRD/活动数据后台PRD.md`
...
- `Outputs/XingYu/星与商业空间粉丝应援活动增长解决方案.md`
- `Outputs/XingYu/商场合作话术.md`
- `Wiki/Playbooks/商场粉丝经济数据报告模型.md`
...
- `Projects/Writing/华南湿季与ww.md`
- `Raw/Writing/2026-05-ww原始片段.md`
- `Wiki/Concepts/湿气作为情绪结构.md`
...
- `Raw/Writing/私人语言词典.md`
- `Wiki/Concepts/亲密关系中的私人语言.md`
...
- `Projects/Personal_System/稳定复利底盘.md`
- `Wiki/Concepts/系统拥有者模式.md`
...
- `Inbox/Daily_Capture/2026-05-10.md`
...
```markdown
## Trading System
- [[Wiki/Playbooks/盘前30分钟热度股SOP]]
- [[Wiki/Playbooks/AI高弹性成长股选股模型V2]]
- [[Wiki/Playbooks/热度股判断框架]]
- [[Wiki/Concepts/题材潮流生命周期]]
- [[90_System/Templates/股票复盘模板]]

## XingYu / Product
- [[Projects/XingYu/星与产品定位升级]]
- [[Projects/XingYu/应援任务解锁系统PRD]]
- [[Wiki/Products/应援资源解锁池]]
- [[Outputs/XingYu/星与商业空间粉丝应援活动增长解决方案]]

## Writing
- [[Projects/Writing/华南湿季与ww]]
- [[Wiki/Concepts/湿气作为情绪结构]]
- [[Wiki/Concepts/关系中的提前撤退]]
- [[Wiki/Playbooks/冷感男性叙事方法]]

## Personal System
- [[Projects/Personal_System/稳定复利底盘]]
- [[Wiki/Concepts/系统拥有者模式]]
- [[Projects/Body/增肌训练系统]]
...
- [[Wiki/Concepts/新身份重估]]
- [[Wiki/Concepts/题材潮流生命周期]]
- [[Wiki/Concepts/证券交易_vs_fashion_trends]]
- [[Wiki/Concepts/湿气作为情绪结构]]
- [[Wiki/Concepts/关系中的提前撤退]]
- [[Wiki/Concepts/系统拥有者模式]]
...
- [[Wiki/Playbooks/热度股判断框架]]
- [[Wiki/Playbooks/AI高弹性成长股选股模型V2]]
- [[Wiki/Playbooks/饭圈活动任务闭环]]
- [[Wiki/Playbooks/冷感男性叙事方法]]

## Products
- [[Wiki/Products/星与应援任务平台]]
- [[Wiki/Products/应援资源解锁系统]]
- [[Wiki/Products/应援资源解锁池]]
```

---

## 6.3 `Projects/Index.md`
...
- [[Projects/XingYu/星与产品定位升级]]
- [[Projects/XingYu/应援任务解锁系统PRD]]
- [[Projects/XingYu/MVP/星与应援任务平台MVP]]
- [[Projects/XingYu/MVP/活动页_报名任务解锁结构]]

## Trading Scanner
- [[Projects/TradingScanner/盘前热度股扫描器需求]]
